package com.mas_allure.context;
...
public class Constants {
	...
	public final static String PROJECT_NAME = "MAS Allure";
	...
	public final static String PROPERTY_FILE_PATH = WORKING_DIRECTORY + "\\src\\test\\resources\\config\\";
